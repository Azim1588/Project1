...
city_coordinates = {}
with open(r'C:\Users\ABAIS\Downloads\coordinates (1).csv', 'r') as file:
...
adjacency_graph = {}
with open(r'C:\Users\ABAIS\Downloads\Adjacencies.txt', 'r') as file:
    for line in file:
...
def display_graph():
    G = nx.Graph()
    for city, neighbors in adjacency_graph.items():
        G.add_node(city)
...
while True:
    ...
    method = int(input("Enter the method number (1-7): "))
    ...
    if method == 1:
        ...
        print("Invalid method selection. Please")
